...
public class Buyticket extends JFrame implements ActionListener {
        JLabel bkground,l1,l2,l3,l4;
        JTextField t1;
        JButton HomeButton,ScheduleBut, TeamsButton, ticketButton, MenuButton, KheloShopBut, SignupButton,LoginButton,SignupButton1; 
        JPanel p1, p2,p3,p4;
        ...
        l1 = new JLabel("Buy Your Ticket Now");
        l1.setBounds(370, 55, 300, 100);
        l1.setForeground(Color.BLACK);
      l1.setFont(new Font ("Serif", Font.BOLD, 25));

        l2 = new JLabel("Please go through login to buy your ticket");
        l2.setBounds(330, 130, 480, 100);
        l2.setForeground(Color.BLACK);
      l2.setFont(new Font("Serif",Font.BOLD, 16));
       

        l3 = new JLabel("Please go through SignUp to buy your ticket");
        l3.setBounds(330, 260, 550, 100);
      ...
      l3.setFont(new Font("Serif",Font.BOLD,15));
               ...
               SignupButton.setOpaque(false);
                ...
                LoginButton.setBounds(370, 220, 200, 30);
                LoginButton.addActionListener(this);

               SignupButton1= new JButton("Signup");
                SignupButton1.setFont(new Font("Rockwell", Font.BOLD, 20));
                SignupButton1.setBackground(Color.gray);
                SignupButton1.setForeground(Color.white);
                SignupButton1.setBounds(370, 350, 200, 30);
