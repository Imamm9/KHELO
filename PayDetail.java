...
public class PayDetail extends JFrame implements ActionListener {
    ...
    public PayDetail() {
        ...
        Color dark6 = new ColorUIResource(224, 255, 255);
        r1.setBackground(dark6);
