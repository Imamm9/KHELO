...
public class Contact extends JFrame implements ActionListener {
    ...
    JButton HomeButton, ScheduleBut, TeamsButton, ticketButton, MenuButton, KheloShopBut, SignupButton,
            BackButton;
    JPanel p1, p2, p3, p4;
    ...
    public Contact() {
        ...
        l2 = new JLabel("Contact   01300807969");
        l2.setBounds(350, 120, 480, 100);
        l2.setForeground(Color.BLACK);
        l2.setFont(new Font("Serif", Font.BOLD, 20));
		
		
		l3 = new JLabel("Mail   khelo2023@gmail.com");
        l3.setBounds(350, 150, 300, 100);
        l3.setForeground(Color.BLACK);
        l3.setFont(new Font("Serif", Font.BOLD, 20));

        l4 = new JLabel("Address  k/a Kuratoli,Kuril");
		                         
        l4.setBounds(350, 180, 480, 100);
