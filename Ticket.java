...
public class Ticket extends JFrame implements ActionListener {
    ...
    public Ticket () {
        ...
        l1 = new JLabel("    Ticket price");
        l1.setBounds(370, 55, 300, 100);
        l1.setForeground(Color.BLACK);
        l1.setFont(new Font("Serif", Font.BOLD, 25));

        l2 = new JLabel("Exclusive  =  $1000");
        l2.setBounds(350, 100, 480, 100);
        l2.setForeground(Color.BLACK);
        l2.setFont(new Font("Serif", Font.BOLD, 25));

        l3 = new JLabel("Premium    =  $800"); 
        l3.setBounds(350,140 , 300, 100);
        l3.setForeground(Color.BLACK);
        l3.setFont(new Font("Serif", Font.BOLD, 25));

        l4 = new JLabel("General    =   $600");
