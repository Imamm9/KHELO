...
public class Feedback extends JFrame implements ActionListener {
    ...
    public Feedback() {
        ...
        l1 = new JLabel("  Share your thoughts");
        l1.setBounds(370, 55, 300, 100);
        l1.setForeground(Color.BLACK);
        l1.setFont(new Font("Serif", Font.BOLD, 25));

        l2 = new JLabel("Write Here");
		...
		// l3 = new JLabel("Email");
        //l3.setBounds(370, 170, 300, 100);
        //l3.setForeground(Color.BLACK);
        //l3.setFont(new Font("Serif", Font.BOLD, 20));

        //l4= new JLabel("Write here");
        //l4.setBounds(350, 195, 480, 100);
        //l4.setForeground(Color.BLACK);
        //l4.setFont(new Font("Serif", Font.BOLD, 20));


                 /* t1 = new JTextField();
                t1.setBounds(350,160,100,20);


                 t2 =  new JTextField();
                 t2.setBounds(350,185,120,20);*/

                    t3 =  new JTextField();
                     t3.setBounds(350,210,200,80);
